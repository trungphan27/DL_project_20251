...
DATASET_DIR = os.path.join(DATA_ROOT, "celeba_hq_256", "without_mask")  # Ground truth (unmasked faces)
MASKED_DIR = os.path.join(DATA_ROOT, "celeba_hq_256", "with_mask")      # Pre-masked faces

CHECKPOINT_DIR = os.path.join(BASE_DIR, "checkpoints")
RESULT_DIR = os.path.join(BASE_DIR, "results")

# Hyperparameters
IMG_SIZE = 256          # CelebA-HQ is 256x256
